...
public class TutorialController : MonoBehaviour
{
    ...
    void Start()
    {
        if (Input.touchSupported)
        {
            ...
            targetButtonSelect.Text = "If the Button is on (it'll be yellow), touch the Big Circle Button to turn it off. Then press Next to continue.";
            targetButtonSelect.Initialize = EmptyInitialization;
            targetButtonSelect.IsComplete = AnyKeyCondition;
            Tasklist.Add(unitButtonSelect);
